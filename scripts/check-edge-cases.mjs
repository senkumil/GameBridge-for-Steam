...
// 8. Logo position marker v3 and read-back verification in artwork.ts
if (!artworkTs.includes("LOGO_POSITION_STORAGE_PREFIX = 'gdl_logo_position3_'")
	|| !artworkTs.includes('readCustomLogoPositionBackend(')
	|| !artworkTs.includes('isLogoPositionVerified(')) {
	throw new Error('artwork.ts must use gdl_logo_position3_ and readCustomLogoPositionBackend for verification.');
}
