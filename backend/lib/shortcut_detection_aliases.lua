-- Maintained executable/title abbreviations. An alias narrows candidate search;
-- the detector still verifies official title/launch metadata before auto-linking.
