...
local function recover_delisted_game(appid)
    ...
    local data = {
        ...
        capsule_image = asset_root .. "capsule_616x353.jpg",
        capsule_imagev5 = asset_root .. "library_600x900_2x.jpg",
        background = asset_root .. "library_hero.jpg",
        background_raw = asset_root .. "library_hero.jpg",
        short_description = "",
